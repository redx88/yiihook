...
class XtableController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Xtable']))
		{
			$model->attributes=$_POST['Xtable'];
			
			if($model->validate()){
				
				/*$postFields = array(
					'firstName' => $_POST['Xtable']['firstName'],
					'lastName' => $_POST['Xtable']['lastName'],
					'mi' => $_POST['Xtable']['mi'],
				);*/
				
				$postFields = "firstName=".$_POST['Xtable']['firstName']
					."&lastName=".$_POST['Xtable']['lastName']
					."&mi=".$_POST['Xtable']['mi'];
					
				$referral = RestController::postData('xtables', $postFields);
								
				if (Yii::app()->request->isAjaxRequest)
                {
                    echo CJSON::encode(array(
                        'status'=>'success', 
                        'div'=>"Xtable successfully added"
                        //'div'=>$referral
                        ));
                    exit;               
                }
